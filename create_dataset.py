...
FEATURES_PATH = "/content/drive/MyDrive/OVQA_publish/features.pkl"
...
class OVQADataset(Dataset):
    ...
    def __init__(self, json_file, root_dir, task, phase, transform=None):
        ...
        self.task = task
        self.phase = phase
        self.img_feat_vqa = np.load(FEATURES_PATH, allow_pickle=True)
    ...
    def __getitem__(self, idx):
        ...
        sample = {'image': image_feat,
                  ...
                  'question_type_label': F.one_hot(torch.tensor([[Q_TYPE_LABLE_DICT[question_type]]]),
                                                   len(Q_TYPE_LABLE_DICT)),
                  'answer_text': answer,
                  'answer_type_label': F.one_hot(torch.tensor([[ANS_TYPE_LABLE_DICT[answer_type]]]),
                                                 len(ANS_TYPE_LABLE_DICT)),
                  'qid': qid}
